...
fruits.forEach(value => console.log(value)); // 화살표함수로 하는 법
...
const objArray = [
    ...
    {name:'마리아', score:90, math:80, sci:70},
    {name:'아담', score:70, math:80, sci:70},
    {name:'이브', score:65, math:80, sci:70}
]
// 성적(score) 순으로 정렬을 해보세요.
// math와 sci의 평균을 구하세요. 
// math 점수가 80점 이상인 사람 